...
import jeson1 from "../img/jeson1.jpeg";
...
import jeson001 from "../img/jeson.001.jpeg";
                ...
                <div className="row">
                  <div className="col-lg-6 ok">
                    <div className="card-info padd-15 text-center">
                      <h1 className="text display-7 text-light">Hi am Jeson B. Rafael</h1>
                      <p className="self text-light">
                       A System Analyst  and Web Developer 
                      </p>
                      <p className="self text-light">
                  ...
                  <div className="col-lg-4">
                    <div className="card">
                      <img src={jeson1} alt="Profile Picture of  Jeson B. Rafael"/>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-md-3 col-sm-6 text-lg-start text-center">
            <h5 className="footer-img text-black fw-bold">  <img src={jeson001} alt="" />&nbsp;&nbsp;About</h5>
            <p className="text-black">Rafael Jeson B.<br/>BSIT-4-C</p>
          </div>
          {/* Column 2 */}
          <div className="col-md-3 col-sm-6 text-lg-start ps-lg-5 ps-0 text-center">
            <h5 className=" text-black fw-bold">Address</h5>
           <p className=" text-black">Purok Fatima Barangay Tagukon Kabankalan<br/>City Negros Occidental</p>
          </div>
          {/* Column 3 */}
          <div className="col-md-3 col-sm-6 text-black-start text-center">
            <h5  className=" text-black fw-bold ">📞Contact</h5>
            <p className="m text-black">Email:jesonrafael6@gmail.com<br/>Phone: 09093441778</p>
          </div>
          {/* Column 4 */}
          <div className="col-md-3 col-sm-6 text-lg-start text-center">
